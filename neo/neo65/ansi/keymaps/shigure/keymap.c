...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [3] = LAYOUT_hot(
        RM_TOGG, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, _______, KC_F13,  KC_F14,  QK_BOOT, _______, RM_SATU,
        ...
        _______, _______, _______,                   _______,                            TO(0),   _______,          RM_VALD, RM_PREV, RM_VALU
    )
};
