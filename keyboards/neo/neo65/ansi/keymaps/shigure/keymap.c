...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_hot(
		...
		_______, _______, _______, KC_CALC, _______, _______, SERACH,  TSK_MGR, _______, _______, _______, _______,          _______, KC_MUTE,
	...
	[2] = LAYOUT_hot(
		...
		_______, _______, _______, KC_CALC, _______, _______, _______, KC_P0,   KC_P0,   KC_PDOT, _______, _______,          _______, _______,
		_______, GU_TOGG, _______,                   KC_DEL,                             _______, _______,          _______, _______, _______
	),
	[3] = LAYOUT_hot(
		RGB_TOG, _______, _______, _______, _______, KC_VOLD, KC_VOLU, KC_MPLY, KC_MUTE, _______, _______, KC_F13,  KC_F14,  _______, _______, RGB_SAI,
